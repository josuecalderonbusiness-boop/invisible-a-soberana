...
<div style="font-family: Georgia, 'Times New Roman', serif; max-width: 480px; margin: 0 auto; padding: 32px 24px; color: #2b2320;">
  ...
  <div style="text-align: center; margin: 0 0 28px;">
    ...
    <p style="font-size: 13px; margin: 14px 0 0;">
      <a href="https://www.google.com/calendar/render?action=TEMPLATE&text=Experiencia+Soberana&dates=20260906T000000Z/20260906T011500Z&details=Tu+experiencia+ya+est%C3%A1+reservada.+Accede+desde+tu+Espacio.&location=https://invisible-a-soberana.josuecalderon.lat/mi-espacio" style="color:#b8892a;text-decoration:none;">📅 Agregar el sábado 5 de septiembre a mi calendario</a>
    </p>
  </div>
