// api/send-wa.js
// Endpoint para enviar mensajes de WhatsApp desde Orbit
// Vercel → Meta WhatsApp Cloud API
...
export default async function handler(req, res) {
  ...
  if (auth !== 'Bearer soberana2026orbit') {
  ...
  try {
    ...
    console.log('WA send response:', JSON.stringify(data));
