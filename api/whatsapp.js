...
const MASTERCLASS_EVENTO_FIN = new Date('2026-08-29T20:15:00-05:00');
  ...
  // mensaje sin revisar masterclassEnVivo() primero, ver entry-product-system/SKILL.md.
    ...
    if (masterclassEnVivo()) {
      await sendWhatsApp(phone,
        ...
        `Nos vemos el sábado 29 de agosto, 7:00 p.m. (Colombia).`
      );
    ...
    await sendWhatsApp(phone,
      `¿Ya guardaste la fecha? 💛 Nos vemos el sábado 29 de agosto a las 7:00 p.m. (Colombia).\n\n` +
