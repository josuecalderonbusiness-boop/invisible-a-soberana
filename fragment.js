function flyStarTo(fromEl, starIdx) {
  ...
  star.textContent = '★';
  star.style.cssText = 'position:fixed;z-index:99999;font-size:22px;color:#D4A843;text-shadow:0 0 12px rgba(212,168,67,0.9);pointer-events:none;left:'+(from.left+from.width/2-11)+'px;top:'+(from.top+from.height/2-11)+'px;';
