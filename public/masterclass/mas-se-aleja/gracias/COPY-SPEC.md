...
Este es el copy que ve el 100% de las visitantes hasta el **12 de septiembre de 2026, 8:15 p.m. hora Colombia** (`EVENTO_FIN`, ver §5).
...
| Píldora de fecha | Calculada en JS, auto-ajustada al huso del visitante (ver §6) — texto base: "Sábado 12 de septiembre · 7:00 p.m. (tu hora)" para quien esté en huso Colombia |
...
```js
EVENTO_FIN = 2026-09-12T20:15:00-05:00   // fin de la última sesión (Zoom Básico, 2 sesiones)
```
...
- Una constante separada `EVENTO_INICIO = 2026-09-12T19:00:00-05:00` solo para calcular la hora mostrada en la píldora de fecha (§6) — mismo valor que usa la landing internamente, no debería divergir nunca.
