...
const campanas = [
  {
    ...
    subject: 'Guarda la fecha: sábado 12 de septiembre, 7:00pm 💛',
    segmentId: 6,
    htmlContent: htmlBranded(
      [
        ...
        'El sábado 12 de septiembre a las 7:00pm (hora Colombia) vamos a hablar de eso — no de otra técnica más, sino de por qué mientras más te esfuerzas por salvar tu relación, más te vas perdiendo tú.',
  ...
  },
  {
    ...
    subject: 'Mañana es el día 💛 (sábado 12, 7:00pm)',
    segmentId: 7,
    htmlContent: htmlBranded(
      [
        'Hola {{contact.FIRSTNAME}} 💛',
